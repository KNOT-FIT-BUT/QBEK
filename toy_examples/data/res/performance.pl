...
# total test paper is 500
my $paperNumber = 500;

# read author keyphrases
my $testpapername = shift;
my $answerset_dir = shift;
...
sub MeasurePerformance
{
  ...
  my $current_answerset = $answerset_dir."/test.".$current_set.".stem.final";
...
print "You answered ".$candidateCnt." over 500 test document\n";
